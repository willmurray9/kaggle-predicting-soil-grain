...
Complete context retains a mean advantage after removing its largest beneficiary, strengthening its local evidence compared with yesterday's multi-scale result. This diagnostic does not change the fixed queue, prove a causal effect separate from hosted-response variability, or establish public/private performance.
